  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        'rounded-lg border border-border bg-background-secondary/95 backdrop-blur-xl',
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      'px-3 py-2 text-xs font-display font-semibold uppercase tracking-wider text-foreground-muted',
      className
    )}
    {...props}
  />
